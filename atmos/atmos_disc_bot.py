    ...
    async def send_embed(product_list: List[Product], malaysia_datetime):
        ...
        if channel:   
            for product in product_list:
                ...
                embed.add_field(name = "Raffle Status", value = product.raffle_status, inline = True)
                embed.add_field(name = "Raffle End Date", value = product.raffle_end_date, inline = True)
                embed.add_field(name = "\u200B", value = "\u200B") # New line
                embed.add_field(name = "Raffle Time Left", value = product.raffle_time_left, inline = True)     
